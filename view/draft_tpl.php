...
<!--<form method="post" action="./?ctrl=ordering&action=push_order">
	...
	<label><input type="checkbox" name="push_order"><i>Отправить заказ в обработку</i></label><br>
	После того, как вы поставите эту галочку, и нажмете на кнопку "сохранить изменения" или "отправить заказ в обработку", ваш заказ поступит менеджерам магазина, и Вы больше не сможете его редактировать. Менеджер свяжется с Вами для уточнения деталей и подтверждения заказа. Также, если вы захотите после отправки заказа что-либо изменить, свяжитесь с менеджером магазина или службой поддержки.
